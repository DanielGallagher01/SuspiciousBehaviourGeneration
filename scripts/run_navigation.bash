...
java -cp out:lib/pddl4j-4.0.0.jar com.suspiciousbehaviour.app.Main \
  src/test/resources/benchmarks/pddl/navigation/domain.pddl \
  src/test/resources/benchmarks/pddl/navigation/11x11-maze.pddl \
  src/test/resources/benchmarks/pddl/navigation/11x11-maze-alt.pddl
