...
java -cp out:lib/pddl4j-4.0.0.jar com.suspiciousbehaviour.app.Main \
  src/test/resources/benchmarks/pddl/sokoban/domain.pddl \
  src/test/resources/benchmarks/pddl/sokoban/problem.pddl \
  src/test/resources/benchmarks/pddl/sokoban/problem-alt.pddl
